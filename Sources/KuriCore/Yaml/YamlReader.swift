...
private extension YamlReader {
    func readYaml(for key: String, from yaml: Yaml) -> Yaml {
        return yaml[.string(key)]
    }
    
    func readString(for key: String, from yaml: Yaml) -> String? {
        return readYaml(for: key, from: yaml).string
    }
    
    func readStringFromRoot(for key: ComponentYamlProperty) -> String? {
    ...
    func readYamlFromComponent(for key: ComponentYamlProperty, and componentType: String, from yaml: Yaml) -> String? {
        let yamlForCompoennt = yaml[.string(componentType)]
        return yamlForCompoennt[.string(key.rawValue)].string
    }
    
    func readYamlForComponent(componentType: String, from yaml: Yaml) -> Yaml {
    ...
    func readYamlForComponent(generateComponent: GenerateComponent, from yaml: Yaml) -> Yaml {
